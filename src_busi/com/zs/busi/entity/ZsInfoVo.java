...
@Component
public class ZsInfoVo implements Serializable {
	/**
	 * 
	 */
	...
	public String lastFollowDate;//最新跟进日期 define by lu
	public String createDate;//创建日期 define by lu
	public String intentionCreateDate;//意向条件创建日期 define by lu
	public String intentionModifyDate;//意向条件更改日期 define by lu
	public String progGuid; //项目id
	...
	public int length;//2016/1/6 起始项，每页长度
	public String cusType;//客户类型：逾期客户、待访问客户等
	...
	public String getIntentionCreateDate() {
		return intentionCreateDate;
	}



	public void setIntentionCreateDate(String intentionCreateDate) {
		this.intentionCreateDate = intentionCreateDate;
	}
	...
	public String getIntentionModifyDate() {
		return intentionModifyDate;
	}



	public void setIntentionModifyDate(String intentionModifyDate) {
		this.intentionModifyDate = intentionModifyDate;
	}
public ZsInfoVo() {
	...
	public ZsInfoVo(String cusName, String cusNo, String compSymbol,
	...
	public ZsInfoVo(String age, String followWay, String intentionType,
