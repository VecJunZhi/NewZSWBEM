...
@Entity
public class XsCstBelongToAjax {
	 ...
	 * @param redirect_url
	 */
	public XsCstBelongToAjax(String cst_type, String redirect_url) {
		super();
		this.cst_type = cst_type;
		this.redirect_url = redirect_url;
	}
	 ...
	 */
	public XsCstBelongToAjax(String cst_type, String cst_name,
	...
	public XsCstBelongToAjax(String cst_type) {
		super();
		this.cst_type = cst_type;
	}
