<%@ page language="java"  pageEncoding="utf-8"%> <!-- 姝ゅ鎯虫敼涓簎tf-8,濡傛灉鏀逛负gbk锛屼紶鍒板悗鍙扮殑缃笟椤鹃棶鐨勫悕瀛椾负涔辩爜锛屾殏鏃舵湭澶勭悊 -->
...
<body>
    ...
    <div class="searchpanel1 border-1px">
        <form id="form-searchbox" class="searchpanel noborder" >
            <ul class="searchbox">
                <li class="query_btn">
                    <span class="showname" value="1">瀹€��鎴?/span><div class="option hide"><div value="1" data-ac="active" class="cus_item">瀹€��鎴?/div><hr class="border-1px"><div value="2" data-ac="active" class="cus_item">缃笟椤鹃棶</div></div>
                </li>
                <li class="query_input">
                    <input type="search" class="query-input" placeholder="璇疯緭鍏ュ鎴峰鍚嶆垨鐢佃瘽"> <i class="clear hide"></i>
                </li>
            </ul>
        </form>
    </div>
            ...
            <div class="panel_group" style="transition: transform 0ms; -webkit-transition: transform 0ms; transform-origin: 0px 0px 0px; transform: translate(0px, 0px) scale(1) translateZ(0px);">
                ...
                <div class="panel_group_content select" _index="0">
                    <ul> 
	                   	 	...
	                   	 	<c:forEach items="${duspinlistByYWY}" var="custom">
...
<!-- <footer>
        ...
        <div>
            <a data-ac="active" id="btnCallBack" class="button cancel borderbtn" href="javascript:">鍥?鏀?/a>
        </div>
        
        <div>
            <a data-ac="active" id="btnAllot" class="button" href="javascript:">鍒?閰?/a>
        </div>
    </footer> -->
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        //add by 鏉庣湡蹇?鏍规嵁璁板綍cookie璁剧疆椤甸潰鐘舵�? cookie鍊兼牸寮?tab绱㈠紩#鍒楄〃鍒嗙粍绱㈠紩
