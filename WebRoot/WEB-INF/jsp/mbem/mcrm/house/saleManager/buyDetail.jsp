...
<body>
	<div class="box-wrap " style="min-height: 794px;">
	    <div class="head">
	        <span class="name">认购明细</span>
	        <span class="date">${buyDateRange}</span>
	    </div>
	    <div class="panel">
	            ...
	            <ul class="list">
	            	            		                <li><span class="name">新增认购</span><span class="num"><em>0</em>元</span></li>
	            		            	            		                <li><span class="name">认购价格变更</span><span class="num"><em>0</em>元</span></li>
	            		            	            		                <li><span class="name">认购换房差额</span><span class="num"><em>0</em>元</span></li>
	            		            	            		                <li><span class="name">认购退房</span><span class="num"><em>0</em>元</span></li>
	            		            	            		            	            		            	            		            	            </ul>
	            <div class="total border-1px">
	                净认购<span class="num"><em>0</em>元</span>
	            </div>
	        </div>
	    </div>
	    	    <div class="panel">
	        ...
	        <div class="panel-body">
	            <ul class="list">
	            		            		                <li><span class="name">新增认购</span><span class="num"><em>0</em>套</span></li>
	            		            		            		            		            		                <li><span class="name">认购退房</span><span class="num"><em>0</em>套</span></li>
	            		            		            		            		            </ul>
	            <div class="total border-1px">
	                净认购<span class="num"><em>0</em>套</span>
	            </div>
	        </div>
	    </div>
	    	</div>
