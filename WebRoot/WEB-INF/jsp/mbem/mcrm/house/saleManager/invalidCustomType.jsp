...
<body>
    ...
    <article id="scrollArticle" class="scrollArticle">
        ...
        <div id="wrapper" class="follow" style="overflow: hidden;">
          ...
          <c:forEach items="${invalidlistByYWY }" var="overdue" varStatus="status"> 
                ...
                <div class="panel_group_content select" _index="0">
                    <ul> 
	                    ...
	                    <c:forEach items="${invalidCustByYWY}" var="detail" varStatus="status">
	                 	 <%--   ${overdue.userGuid}</br>
	                   	 ${detail.userGuid}</br> --%>
	                   	 <c:if test="${overdue.userGuid == detail.key}">
	                   	   <%--  ${detail.key}</br> --%>
	                   	 	<c:forEach items="${invalidCustByYWY[detail.key]}" var="custom">
