...
<body>
    ...
    <article id="scrollArticle" class="scrollArticle">
        ...
        <div id="wrapper" class="follow" style="overflow: hidden;">
          ...
          <c:forEach items="${followinglistByYWY }" var="overdue" varStatus="status"> 
                ...
                <div class="panel_group_content select" _index="0">
                    <ul> 
	                    ...
	                    <c:forEach items="${followingCustByYWY}" var="detail" varStatus="status">
	                 	 <%--   ${overdue.userGuid}</br>
	                   	 ${detail.userGuid}</br> --%>
	                   	 <c:if test="${overdue.userGuid == detail.key}">
	                   	   <%--  ${detail.key}</br> --%>
	                   	 	<c:forEach items="${followingCustByYWY[detail.key]}" var="custom">
