...
<body>
    ...
    <div class="datemenu">
        <ul class="datelist cls">
        	            <li id="total" data-ac="active" class="" range="total"><span>累计</span></li>
                        <li id="week" data-ac="active" class="" range="week"><span>本周</span></li>
                        <li id="month" data-ac="active" class="" range="month"><span>本月</span></li>
                        <li id="year" data-ac="active" class="" range="year"><span>本年</span></li>
                        <li id="range" data-ac="active" class="" range="other"><span>自定义</span></li>
    ...
    <div class="card" id="intentContent"> <div class="title border-1px click_href" data-ac="active" cst_type="intention">
        <h4>意向客户</h4><span class="num">${analysisInfo.intention}</span>
        </div>
        <ul class="list cls ">
        ...
        <ul class="list2">
            <li data-ac="active" class="border-1px click_href" cst_type="invalidCst"><span class="name">无效客户</span><span class="num">${analysisInfo.invalidCst}</span></li>
            <li data-ac="active" class="border-1px click_href" cst_type="confessCst"><span class="name">认筹客户</span><span class="num">${analysisInfo.confessCst}</span></li>
            <li data-ac="active" class="border-1px click_href" cst_type="buyCst"><span class="name">认购客户</span><span class="num">${analysisInfo.buyCst}</span></li>
            <li data-ac="active" class="border-1px click_href" cst_type="signUpCst"><span class="name">签约客户</span><span class="num">${analysisInfo.signUpCst}</span></li>
        </ul></div>
    <div class="card card1">
        ...
        <div class="table-wrap">
            <div class="title"><span class="name">来访客户</span><span class="time">${type}</span></div>
