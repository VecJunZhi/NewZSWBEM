...
<body>
	<header>
		<div class="header">
			<ul>
				<li><a href="javascript:void(0);" data-url="/mbem/mcrm/house/custAnalysis/followReport.action?flg=today">跟进分析</a>
				</li>
				<!-- <li><a href="javascript:void(0);" data-url="#"> 转化率分析 </a></li> -->
				<li class="a_act"><a href="javascript:void(0);" data-url="#"> 成交分析 </a></li>
			</ul>
		</div>
	</header>
	<div class="nav">
		<nav>
			<ol class="datelist">
				<li id="total"><a href="javascript:void(0);" data-url="/mbem/mcrm/house/custAnalysis/dealReport.action?flg=alltime">累计 </a></li>
				<li id="yesterday"><a href="javascript:void(0);"
					data-url="/mbem/mcrm/house/custAnalysis/dealReport.action?flg=yesterday">昨日</a></li>
				<li id="today" class="a_act"><a href="javascript:void(0);"
					data-url="/mbem/mcrm/house/custAnalysis/dealReport.action?flg=today">今日</a></li>
				<li id="curweek"><a href="javascript:void(0);"
					data-url="/mbem/mcrm/house/custAnalysis/dealReport.action?flg=curweek">本周</a></li>
				<li id="curmonth"><a href="javascript:void(0);"
					data-url="/mbem/mcrm/house/custAnalysis/dealReport.action?flg=curmonth">本月</a></li>
	...
	<article>
		...
		<figure class="clearfix" style="height:150px;">
			<!--<div class="a_li fl">
							...
							<li>
								<a class="clearfix" href="javascript:void(0);">
									<div class="ac_div clearfix">
										<!-- <p>
											<i>总计</i> <b> <font>0</font>套
											</b>
										</p> -->
										<p>
											<i>总计</i> <b><font>${groups.rgts}</font>套</b>

										</p>
										<p>
											<i></i> <b><font>${groups.qyts }</font>套</b>
										</p>
									</div>
								</a> 
								<!-- <a class="clearfix" href="javascript:void(0);">
									<div class="ac_div clearfix">
										<p>
											<i>平均</i> <b> <font>0</font>套
											</b>
										</p>
										<p>
											<i></i> <b><font>0</font>套</b>
										</p>
										<p>
											<i></i> <b><font>0</font>套</b>
										</p>
						...
						<ul>
							...
							<c:forEach items="${ywy_grouplist}" var="ywylist" varStatus="status">
								<c:if test="${groups.groups==ywylist.groups }">
									<a class="clearfix" data-ac="act_a"
										href="#"><div
											class="a_user_name clearfix">
											<span>${ywylist.ywy }</span><i><q style="display: none;">逾0</q></i>
										</div>
										<div class="ac_div clearfix">
											<!-- <p>
												<font>0</font>套
											...
											<p>
												<b><font>${ywylist.rgts}</font>套</b>
											</p>
											<p>
												<b><font>${ywylist.qyts}</font>套</b>
											</p>
										</div>
									</a>
								</c:if>
	...
	<div class="time-wrap" id="time-wrap">
		<ul>
			<li data-ac="active" class="border-1px"><span class="k">开始时间：</span><span
				class="v"><input id="beginTime" class="kbtn" 
					 type="text"></span></li>
			<li data-ac="active"><span class="k">结束时间：</span><span class="v"><input
					id="beginTime" class="kbtn"  type="text"></span></li>
		</ul>
		<div class="btns">
