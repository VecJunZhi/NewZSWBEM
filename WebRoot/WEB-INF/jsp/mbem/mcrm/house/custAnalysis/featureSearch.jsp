...
<script>
	    ...
	    $(document).ready(function(){
			...
			$(".sure").click(function(){
				...
				_f.action = "/mbem/mcrm/house/custAnalysis/feature.action?cstType="+cstType+"&reportType=range";
				_f.submit(); 
			});
			$(".cancel").click(function(){
				//history.back();
				window.location.replace("/mbem/mcrm/house/custAnalysis/feature.action?cstType=call&reportType=week");
			});
...
<input type="hidden" id="cstType" value="${cstType}">
<ul class="border-1px">
