...
<script  src="/mbem/mcrm/business/js/jquery-1.9.1.min.js"></script>
...
<script>
	    ...
	    $(document).ready(function(){
	    	...
	    	$("#search_input").click(function(){
				...
				_f.action = "/mbem/mcrm/house/room/searchRoomInCurBuild.action";
				_f.submit(); 
	    	});
	    }); 
    </script>  
                ...
                <div id="search_1" class="form-group cls">
                    ...
                    <div class="form-control">
                       <ul class="PPmultSelect" id="fanwei">
                            <li class="select"><div><a href="javascript:void(0)">当前楼栋</a></div></li>
                            <li><div><a href="/mbem/mcrm/house/room/searchRoomBulid.action">当前项目</a></div></li>
                       </ul>
                    </div>
                </div>
	             ...
	             <div class="form-control">
                       <ul class="PPmultSelect form-ul" file_type="PPmultSelect" tablename="s_room" for="huxing">
                    		<li value="A01E"><div>A01E</div></li><li value="A01D"><div>A01D</div></li><li value="A01A"><div>A01A</div></li><li value="A01G"><div>A01G</div></li><li value="A01C"><div>A01C</div></li><li value="A01I"><div>A01I</div></li><li value="A01F"><div>A01F</div></li><li value="A01B"><div>A01B</div></li><li value="A01H"><div>A01H</div></li>                       </ul>
            	</div>
            	</div>
            	            </div>
...
<!-- <form id="formpost" action="/Sales/SaleRoomStatus/index" method="get"> -->
...
// 根据url设置当前楼栋和当前项目的链接和样式
 function getUrlInfo(){
    ...
    if(inProject === "1"){
        ...
        $("#fanwei li").eq(0).find("a").eq(0).attr("href","javascript:void(0)");
        //$("#fanwei li").eq(1).find("a").eq(0).attr("href",url+"&inProject=1");
        $("#inProject").val(0);
    }
}   
//获取url中的参数
...
$(function(){
    ...
    function savevalue(dom){
        ...
        Zepto.localStore.set("/Sales/SalesRoomStatus/search/#selected",JSON.stringify(savedata),1);
    }
    ...
    $(".form-ul").delegate("li","touchend",function(){
  	...
  	//恢复上次选择
    var selecteddata=JSON.parse(Zepto.localStore.get("/Sales/SalesRoomStatus/search/#selected"));
    if(selecteddata){
