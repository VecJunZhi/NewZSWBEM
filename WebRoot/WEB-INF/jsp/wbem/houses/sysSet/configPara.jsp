	        ...
	        <div id="tab1" class="tab-pane active"> 
			  <form action="#" method="get" class="form-horizontal">
			  	<div class="control-group noborder-bottom"> 
	       			<label class="control-label" style='text-align:left;width:220px'>无效客户是否自动回收</label>    
			        <div class="controls">
			       		<input id="mmRadio6" type="hidden"   " value=${zsDictionaryEntityMap.get("无效客户自动回收")}  > 
			    ...
			    <div class="control-group noborder-bottom"  id="aa"> 
	       			<label class="control-label" style='text-align:left;width:220px'>无效客户回收天数</label>
			        <div class="controls">
			            <input type="text"  id="sec2"  value=${ zsDictionaryEntityMap.get("无效回收天数")} >天
			        </div>
			    </div>
			    <div class="control-group noborder-bottom">
        			<label class="control-label" style='text-align:left;width:220px'>逾期客户是否自动回收</label>
        			<div class="controls"  >
        				<input id="mmRadio0"  type="hidden"  value=${zsDictionaryEntityMap.get("逾期客户自动回收")} > 
      		    ...
      		    <div class="control-group noborder-bottom"  id="bb1">
        		 	<label class="control-label"  style='text-align:left;width:220px'>逾期后回收天数 </label>
       				<div class="controls" >
          			 	<input type="text"  id="sec0"   value=${ zsDictionaryEntityMap.get("逾期回收天数")}>天
        		 	</div>
     		   	</div>
      			<div class="control-group noborder-bottom"  id="bb2">
        			<label class="control-label" style='text-align:left;width:220px'>逾期天数</label>
        			<div class="controls" >
          				<input type="text" id="sec1"   value=${ zsDictionaryEntityMap.get("逾期天数")} >天
       				</div>
      			</div>
      			<div class="control-group noborder-bottom"  >
        		 	<label class="control-label"  style='text-align:left;width:220px'>公共客户是否允许销售员直接跟进 </label>
       				<div class="controls" >
          			 	<input type="hidden"  id="mmRadio3"    value=${ zsDictionaryEntityMap.get("公共客户是否允许销售员直接跟进")} >
      			...
      			<div class="control-group noborder-bottom" id="cc">
        		 	<label class="control-label"  style='text-align:left;width:220px'>下次跟进间隔天数 </label>
       				<div class="controls" >
          			 	<input type="text" id="sec4"  value=${ zsDictionaryEntityMap.get("下次跟进间隔天数")}>天
        		 	</div>
     		   	</div>
			    <div class="row-fluid ">
...
<script type="text/javascript">
	...
	if($("#mmRadio0").val()=='1'){
   	...
   	$("#saveBtn").click(function(){
   		...
   		$.ajax({
   		 	url:'/wbem/houses/sysSet/updateConfigPara.action',
   		 	data:params,
   		 	type : 'post',
		    dataType : 'json',
		});
