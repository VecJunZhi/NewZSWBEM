	...
	<div class="navbar">
	  <div class="navbar-inner" style="margin-top:5px;">
	    <ul class="nav">
	      ...
	      <li class="divider-vertical"></li>
	      <li class="active"><a href="/wbem/houses/customer/custAssignDusBin.action?menuId=${menuId}">垃圾箱</a></li>
	      <li class="divider-vertical"></li>
	    </ul>
	  </div>
	</div>
	           ...
	           <!-- <div class="row-fluid ">
	             <div class="input-prepend input-append" style="margin-top: 10px;"  id="rebackReason">
	              <span class="add-on" style="width: 103px;margin-right: 5px;">回收原因</span>
	                ...
	                <label class="checkbox inline"> <input type="checkbox" name="rebackReason" value="5"/>其它</label>
	              </div>
	            </div> -->
	            <div class="row-fluid ">
			...
			"ajax": {type: "post",//后台指定了方式。
	         ...
	         columnDefs:[{
	         	targets:11,"render":function(data, type, row, meta){
	         			return "<a style='color:#FAA732' cusId="+data+" oppGUID="+row.oppGUID+ " userGuid="+row.userGuid+" href='#' onclick='cstDetail(\"" + data + "\",\"dusbin\")'>查看</a>&nbsp;&nbsp;"
	         				  +"<a style='color:#FAA732' href='#' onclick='moveToPublic(\"" + data + "\",\""+row.oppGUID + "\",\""+row.userGuid + "\")'>转为公共客户</a>";
	         	}
