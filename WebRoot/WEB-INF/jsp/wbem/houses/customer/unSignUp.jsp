...
<div class="container-fluid">
	        ...
	        <div id="tab1" class="tab-pane active"> 
			  <form action="#" method="get" class="form-horizontal">
	            ...
	            <div class="row-fluid ">
				  ...
				  <input class="span6" id="telOrName" type="text"><!-- <button class="btn btn-primary" style="margin-left: 5px;">搜索</button> --> 
				</div>
	             </div>
				<div class="row-fluid ">
	...
	<div class="widget-box">
		<div class="widget-title"><span class="icon"><i class="icon-th"></i></span><h5>未签约客户列表</h5>
...
$(document).ready(function(){
	...
	$('.data-table').dataTable({
		"ajax": {
			type: "post",//后台指定了方式。
         	url: "/wbem/houses/customer/loadUnSignUpCstList.action",
           ...
           "columnDefs":[
            {
         		targets:12,"render":function(data){
	       			return	"<shiro:hasPermission name='button:urgedManage:unSignUp:cstUrged'><a style='color:#FAA732' href='#' onclick='cstUrged(\"" + data + "\",\"2\")'>催办</a></shiro:hasPermission>&nbsp;"  +
	       					"<shiro:hasPermission name='button:urgedManage:unLending:cstDelay'><a style='color:#FAA732' href='#' onclick='cstDelay(\"" + data + "\",\"2\")'>延期</a></shiro:hasPermission>&nbsp;"+ 
	       			/* "<a style='color:#FAA732' href='#' onclick='cstDelay(\"" + data + "\")'>延期</a>&nbsp;" */
