	...
	<div class="navbar">
	  <div class="navbar-inner" style="margin-top:5px;">
	    <ul class="nav">
	      ...
	      <li id="dayReport"><a href="/wbem/houses/analysis/indexReport.action?reportType=dayReport&menuId=">日报</a></li>
	      <li class="divider-vertical"></li>
	      <li id="weekReport"><a href="/wbem/houses/analysis/indexReport.action?reportType=weekReport&menuId=">周报</a></li>
	      <li class="divider-vertical"></li>
	      <li id="monthReport"><a href="/wbem/houses/analysis/indexReport.action?reportType=monthReport&menuId=">月报</a></li>
	      <li class="divider-vertical"></li>
	      <li id="rangeReport"><a href="#">自定义周期</a></li>
	      <li class="divider-vertical"></li>
	      <li>
	        <form class="navbar-form pull-left" id="datepicker" style="display:none" method="post" action="/wbem/houses/analysis/indexReport.action?reportType=rangeReport&menuId=">
...
$(document).ready(function(){
	...
	$('.data-table').dataTable({
		"ajax": {type: "post",//后台指定了方式。
                 url: "/wbem/houses/analysis/loadAnalysisData.action",
                 data:function(d){			//外部参数传递
                 	...
                 	d.team = encodeURI($('#team').find('option:selected').val());
