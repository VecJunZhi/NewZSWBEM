	...
	<div class="widget-box">
		<div class="widget-title">
		  <ul class="nav nav-tabs">
		    ...
		    <li class="active" ><a data-toggle="tab" href="#tab2" onclick="tabSwitch(this)" target="/wbem/business/customer/custAssignOverdue.action?menuId=${menuId}">逾期客户</a></li>
	...
	<div class="widget-box">
		...
		<div class="widget-content nopadding">
			<table class="table table-bordered data-table">
				<thead>
	                <tr>
						<th><label class="checkbox inline index"> <input type="checkbox" name="radios" />序号</label></th><!-- onclick="allcheck(this)" --> 
						<th>姓名</th>
						<th>电话</th>
						<th>置业顾问</th>
						<th>客户状态</th>
...
$(document).ready(function(){
	...
	$('.data-table').dataTable({
		"ajax": {type: "post",//后台指定了方式。
                 url: "/wbem/business/customer/getZsbusiCustomOverDue.action",
         ...
         "columns":[
          ...
          columnDefs:[{
         	targets:9,"render":function(data, type, row, meta){
	        	...
	        	{ "sortable": false, "targets":[0,1,2,3,4,7,9]}
        	] , 
         "ordering":true,
         "order": [6,"asc"],	
