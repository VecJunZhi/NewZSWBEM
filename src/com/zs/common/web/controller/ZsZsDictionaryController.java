...
public class ZsZsDictionaryController {
	@Autowired
	 ...
	 * @return
	 */
	@RequestMapping(value="/zsconfigPara")
	public String getZsDictionaryByClassesDaoController(Model model){	
	    ...
	    return "/wbem/business/sysSet/configPara";
	}
	/**
	 ...
	 * @return
	 */
	@RequestMapping(value="/zsupdateConfigPara")
	public String updateZsDictionaryByClassesDaoController( String overdueCustomerRecoveryDay,
		...
		return "redirect:/wbem/business/sysSet/configPara";		
	}
}
